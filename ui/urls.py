...
from .views import (FileView, ImportView, IssuesView, MainView, NewProjectView, ProjectSettingView,
		ProjectView, RevisionView)
...
urlpatterns = [
	...
	url(r'^(?P<projectname>[\w-]+)/issues/(?P<revision>[0-9a-fA-F]{7,})', IssuesView.as_view()),
